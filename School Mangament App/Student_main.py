...
student_window.configure(bg="khaki1")  # Set background color
...
profile_button = tk.Button(student_window, text="Profile", command=feature_coming_soon,
                           bg="hot pink", fg="white", font=("Arial", 12))
